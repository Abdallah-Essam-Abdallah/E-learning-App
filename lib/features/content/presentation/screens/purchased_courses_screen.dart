...
import 'package:courses_app/features/content/presentation/screens/course_content_screen.dart';
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: ((context) => CourseContentScreen(
                                          videos: state.courses[index].videos,
                                          course: state.courses[index].title,
                                        ))));
                          },
                          title: AutoSizeText(
